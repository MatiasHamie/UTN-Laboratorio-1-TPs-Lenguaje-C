...
int main()
{
    ...
    LinkedList* listaEmpleadosMap;//Creada para cuando tenga q duplicar la linkedlist
    LinkedList* listaEmpleadosFilter;//Creada para cuando tenga q duplicar la linkedlist
    char seguir='s';
    ...
    do{
        switch(menu())
        {
            ...
            case 10:
                ...
                break;
            case 11:
                listaEmpleadosMap=ll_map(listaEmpleados,map_duplicarSueldo);
                if(listaEmpleadosMap!=NULL){
                    controller_saveAsText("./listaEmp_map.bin",listaEmpleadosMap);
                    controller_saveAsBinary("./listaEmp_map.bin",listaEmpleadosMap);
                    controller_ListEmployee(listaEmpleadosMap);
                }else{
                    printf("ERROR, lista retornada con valor NULL\n\n");
                }
                system("pause");
                break;
            case 12:
                listaEmpleadosFilter=ll_filter(listaEmpleados,filter_Iniciales);
                if(listaEmpleadosFilter!=NULL){
                    controller_saveAsText("./listaEmp_filter.bin",listaEmpleadosFilter);
                    controller_saveAsBinary("./listaEmp_filter.bin",listaEmpleadosFilter);
                    controller_ListEmployee(listaEmpleadosFilter);
                }else{
                    printf("ERROR, lista retornada con valor NULL\n\n");
                }
                system("pause");
